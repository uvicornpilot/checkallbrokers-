...
class ArticlePage(Page):
    ...
    DEFAULT_FAQ = [
        (   "Что делать, если {broker} отклоняет или задерживает вывод средств?",
        ...
        (
            "Чем вам поможет экспресс-аудит спорной ситуации с {broker}?",
        ...
        (
            "Какие документы подготовить для бесплатного разбора ситуации по {broker}?",
